...
from ..data.models.database import get_db, User, RawPost
...
class AnalysisService:
    ...
    async def analyze_trends(self, posts: List[RawPost], keywords: List[str]) -> dict:
        """
    ...
    def _format_top_mentions(self, llm_mentions: List[dict], posts: List[RawPost]) -> List[dict]:
    ...
    def _get_fallback_analysis(self, posts: List[RawPost], keywords: List[str]) -> dict:
