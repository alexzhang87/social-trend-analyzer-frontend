...
class LLMProvider(ABC):
    ...
    @abstractmethod
    def generate_insights_for_cluster(self, cluster_posts: List[RawPost]) -> Dict[str, Any]:
        pass
...
class ZhipuAIProvider(LLMProvider):
    ...
    def _create_fallback_response(self, error_msg: str, cluster_posts: List[RawPost]) -> Dict[str, Any]:
        """创建降级响应，确保系统稳定性"""
