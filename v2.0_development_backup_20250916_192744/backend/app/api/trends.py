...
def professional_analysis(
    ...
    try:
        ...
        result = ProfessionalAnalysisResponse(
            keyword=keyword,
            executive_summary=f"基于您的{stage}产品'{keyword}'在{target_market}的{business_model}模式分析，我们发现该产品具有中等到高等的市场潜力。考虑到您的{budget}预算和{timeline}时间线，建议采用渐进式市场进入策略。",
            pmf_analysis={
                "overall_score": 78,
                "dimensions": {
                    "market_need": 82,
                    "product_solution_fit": 75,
                    "target_customer_clarity": 80,
                    "value_proposition": 76,
                    "competitive_advantage": 73
                },
                "insights": [
                    f"目标市场({target_market})显示出强烈的需求信号",
                    f"当前{stage}适合进行MVP验证",
                    f"{business_model}模式在该领域具有可行性"
                ]
            },
            market_analysis={
                "market_size": {
            ...
            competitive_analysis={
                ...
                "key_competitors": [
                    {"name": "竞争对手A", "strength": "品牌知名度", "weakness": "产品创新不足"},
                    {"name": "竞争对手B", "strength": "技术实力", "weakness": "用户体验一般"},
                    {"name": "竞争对手C", "strength": "市场份额", "weakness": "价格偏高"}
                ],
            ...
            user_insights={
                "target_personas": [
                    {
                        "name": "主要用户群体",
                        "demographics": "25-40岁，中高收入",
                        "pain_points": ["效率低下", "成本过高", "体验不佳"],
                        "motivations": ["提高效率", "节省成本", "获得更好体验"]
                    }
                ],
                "user_journey": {
                    "awareness": "通过社交媒体和搜索引擎",
                    "consideration": "比较功能和价格",
                    "decision": "试用体验和口碑推荐",
                    "retention": "持续价值提供和客户服务"
                },
                "feedback_themes": [
                    "功能实用性",
                    "界面友好性",
            ...
            recommendations={
                "go_to_market": {
                    "strategy": "渐进式市场进入",
                    "phases": [
                        {"phase": "MVP验证", "duration": "2-3个月", "focus": "核心功能验证"},
                        {"phase": "小规模推广", "duration": "3-6个月", "focus": "用户获取和反馈"},
                        {"phase": "规模化扩张", "duration": "6-12个月", "focus": "市场份额扩大"}
                    ]
                },
                "product_development": [
                    "优先开发核心功能",
                ...
                "funding": {
                    "recommended_amount": f"基于您的{budget}预算，建议寻求额外资金支持",
                    "use_cases": ["产品开发", "市场推广", "团队扩建"]
                }
            },
            risk_assessment={
                "high_risks": [
                    {"risk": "市场接受度不确定", "mitigation": "充分的MVP测试"},
                    {"risk": "竞争加剧", "mitigation": "建立差异化优势"}
                ],
                "medium_risks": [
                    {"risk": "技术实现难度", "mitigation": "分阶段开发"},
                    {"risk": "资金不足", "mitigation": "寻求投资或合作"}
                ],
                "low_risks": [
                    {"risk": "团队能力", "mitigation": "持续学习和培训"}
                ],
                "overall_risk_level": "中等"
            },
            data_quality={
                "confidence_level": 85,
                "data_sources": ["市场研究报告", "用户调研", "竞品分析", "行业专家访谈"],
                "limitations": ["部分数据基于预测", "市场变化可能影响准确性"],
