...
# 定义产品和价格ID映射
# 注意：这些是示例价格ID，需要在Stripe仪表板中创建实际的产品和价格
# 创建步骤：
# 1. 登录Stripe仪表板 -> 产品目录
# 2. 创建产品（订阅计划和积分包）
# 3. 为每个产品创建价格
...
STRIPE_PRICE_IDS = {
    # 订阅计划价格ID（月付）
    "starter_monthly": "price_1234567890abcdef",  # Starter计划 $9.99/月
    "pro_monthly": "price_abcdef1234567890",      # Pro计划 $29.99/月
    "plus_monthly": "price_fedcba0987654321",     # Plus计划 $59.99/月
    "enterprise_monthly": "price_135792468ace",   # Enterprise计划 $199.99/月
    
    # 积分包价格ID（一次性购买）
    "credits_small": "price_small_credits_123",   # 小包装 100积分 $9.99
    "credits_medium": "price_medium_credits_456", # 中包装 500积分 $39.99
    "credits_large": "price_large_credits_789"    # 大包装 1000积分 $69.99
}
